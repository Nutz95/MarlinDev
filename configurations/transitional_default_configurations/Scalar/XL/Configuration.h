...
#define CUSTOM_MACHINE_NAME "Scalar XL"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
 #define MACHINE_UUID "244cf732-239c-42e7-86a3-e708e8b39516"
...
// :{ '0': "Not used", '4': "10k !! do not use for a hotend. Bad resolution at high temp. !!", '1': "100k / 4.7k - EPCOS", '51': "100k / 1k - EPCOS", '6': "100k / 4.7k EPCOS - Not as accurate as Table 1", '5': "100K / 4.7k - ATC Semitec 104GT-2 (Used in ParCan & J-Head)", '7': "100k / 4.7k Honeywell 135-104LAG-J01", '71': "100k / 4.7k Honeywell 135-104LAF-J01", '8': "100k / 4.7k 0603 SMD Vishay NTCS0603E3104FXT", '9': "100k / 4.7k GE Sensing AL03006-58.2K-97-G1", '10': "100k / 4.7k RS 198-961", '11': "100k / 4.7k beta 3950 1%", '12': "100k / 4.7k 0603 SMD Vishay NTCS0603E3104FXT (calibrated for Makibox hot bed)", '13': "100k Hisens 3950  1% up to 300°C for hotend 'Simple ONE ' & hotend 'All In ONE'", '60': "100k Maker's Tool Works Kapton Bed Thermistor beta=3950", '55': "100k / 1k - ATC Semitec 104GT-2 (Used in ParCan & J-Head)", '2': "200k / 4.7k - ATC Semitec 204GT-2", '52': "200k / 1k - ATC Semitec 204GT-2", '-2': "Thermocouple + MAX6675 (only for sensor 0)", '-1': "Thermocouple + AD595", '3': "Mendel-parts / 4.7k", '1047': "Pt1000 / 4.7k", '1010': "Pt1000 / 1k (non standard)", '20': "PT100 (Ultimainboard V2.x)", '147': "Pt100 / 4.7k", '110': "Pt100 / 1k (non-standard)", '998': "Dummy 1", '999': "Dummy 2" }
  ...
  #define TEMP_SENSOR_0 5 //5 =E3DV6  ,  10= AluHotend V6/V7,   13=AllInOne
#endif
...
//    #define  DEFAULT_Kd 110.01
//AluHotEnd V6
    //#define  DEFAULT_Kp 35.07
    //#define  DEFAULT_Ki 2.27
    //#define  DEFAULT_Kd 135.39
...
//Scalar XL Heatbed 700W 220V with 3mm aluminum sheet
#define  DEFAULT_bedKp 144.64
#define  DEFAULT_bedKi 20.72
#define  DEFAULT_bedKd 252.40  

// Scalar M Heatbed 400W 220V with 3mm aluminum sheet
//#define  DEFAULT_bedKp 52.13
//#define  DEFAULT_bedKi 9.14
//#define  DEFAULT_bedKd 74.3
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,2560,150}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {150, 150, 2, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {500,500,25,1500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 33 // the duration the buzzer plays the UI feedback sound. ie Screen Click
#define LCD_FEEDBACK_FREQUENCY_HZ 639         // this is the tone frequency the buzzer plays when on UI feedback. ie Screen Click
...
// The supported smoke sensor is MQ2 gaz/smoke detector module for arduino
// IMPORTANT note: On the sensor you have 5V power supply that draws too much current for your arduino/ramps board
// so prefer powering it from a separate power supply as the sensor's heater can draw nearly 1W (datasheet says less than 800mw)
// 
// The sensor has one 5V power input, 1 ground pin, and 1 digital and 1 analog pin for data output
// Both analog  and digital pin are supported by the following code (Uncomment flag USE_ANALOG_MODE to use Analog Mode, and leave it commented to use Digital Mode
//In Analog Mode:
// At the power up, the printer will calibrate the sensor during a few milliseconds. during this time you need to make sure that the sensor is clean and in a clean air without any smoke!
// The Analog pin output voltage will vary from 0V to 5V depening on smoke or gaz particule density.
//In Digital Mode:
//The Digital Output of the module is by default 3.3V when nothing is detected and goes to 0V when a detection is made.
//Flag  INVERT_DIGITAL_SIGNAL will trigger an alarm when the signal goes Down to 0V. If you are using another module, you can use this flag invert the logic.
// when the Threshold is reached the printer will enter a fail safe mode => the same kind as for Thermal Runaway protection mecanism
// You have the option to enable several types of warnings: LCD message, LCD beeps, LCD blink
//IMPORTANT note about HairSpray: the components inside hair spray can be detected by the sensor, and the sensor can trigger the alarm if you apply hair spray on your heat bed and you have some particles heading toward the smoke sensor
...
#include "configurations/transitional_default_configurations/Scalar/XL/Configuration_adv.h"
